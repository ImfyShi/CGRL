...
# from .MorpionSolitaireNNet import OthelloNNet as onnet
from .CSPNNet import OthelloNNet as onnet
...
class NNetWrapper(NeuralNet):
    def __init__(self, game, feature_dim):
        self.nnet = onnet(game, args, feature_dim)
        # self.board_x, self.board_y = game.getBoardSize()
        self.action_size = game.getActionSize()
        self.board_x, self.board_y = self.action_size, feature_dim
