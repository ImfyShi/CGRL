...
if __name__ == '__main__':
    ...
    a_lr, c_lr, update_steps, max_grad_norm, emb_size = float(parameters['a_lr']), float(parameters['c_lr']), parameters['update_steps'], parameters['max_grad_norm'], parameters['emb_size']
    ...
    base_folder = parameters['eval_base_folder']
    write_folder = parameters['eval_write_folder']
    ...
    for instance_folder, instance_set_name in zip(instance_folder_list, instance_set_name_list):
        ...
        excel_name = "../data/generated_results/{}/{}_on_{}.xlsx".format(args.policy_mode, policy_name, instance_set_name)
